...
gst-launch-1.0 nvarguscamerasrc silent=false sensor-id=0 num-buffers=1 ee-mode=0 tnr-mode=0 tnr-strength=0 aeantibanding=0 wbmode=0 gainrange="$n $n" exposurecompensation=0 exposuretimerange="$2000000 $200000" ispdigitalgainrange="1 1" ! "video/x-raw(memory:NVMM),width=3840,height=2160,framerate=(fraction)10/1" ! nvvidconv flip-method=0 ! pngenc ! filesink location="Snap_$3_${n}x_$200us.png"
